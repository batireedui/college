    ...
    if(strlen($str) > 0){
        ...
        for ($f = 1;$f <= $last; $f++)
        {
            ...
            _selectNoParam(
                $cstmt,
                $ccount,
                "SELECT expo FROM parent WHERE student_id in ($str) and expo is not null LIMIT 100 OFFSET " . $fn,
                $expoToken
            );
    ...
    if(strlen($str) > 0){
        ...
        for ($f = 1;$f <= $last; $f++)
        {
            ...
            _selectNoParam(
                $cstmt,
                $ccount,
                "SELECT expo FROM teacher WHERE id in ($str) and expo is not null LIMIT 100 OFFSET " . $fn,
                $expoToken
            );
