...
if (isset($_SESSION['user_id'])) {
    ...
    _selectNoParam(
        $st,
        $co,
        "SELECT btime_user.ajil_id, btime_ajil.ajil, sum(btime_user.credit), btime_user.year FROM `btime_user` INNER JOIN btime_ajil ON btime_user.ajil_id = btime_ajil.id
