...
_select(
    $stmtAz,
    $countAz,
    "SELECT orders.payid, orders.id, zovogner, hend, zognoo, utas, huselt, zproducts.price, itemazjargal.id, itemazjargal.dtuluv, orders.ognoo FROM `itemazjargal` INNER JOIN orders ON itemazjargal.orderid = orders.id INNER JOIN zproducts ON itemazjargal.zproductid = zproducts.id WHERE orders.tuluv = ? and tuluvs=? ORDER BY orders.id DESC",
    "ii",
    ['1', '0'],
    $payidAz,
    $oidAz,
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">АЗ ЖАРГАЛЫН БУРХАН</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input type="submit" class="btn btn-danger" name="azhold" value="Архивлах"/>
                            </div>
                            </form>
                        </div>
