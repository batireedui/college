...
_select(
    $stmtAz,
    $countAz,
    "SELECT orders.payid, orders.id, zovog, zner, tursun, zutas, tursun, zproducts.price, itemhushh.id, itemhushh.dtuluv, orders.ognoo FROM `itemhushh` INNER JOIN orders ON itemhushh.orderid = orders.id INNER JOIN zproducts ON itemhushh.zproductid = zproducts.id WHERE orders.tuluv = ? and tuluvs=? ORDER BY orders.id DESC",
    "ii",
    ['1', '0'],
    $payidAz,
    $oidAz,
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Өвөг дээдсийн гэрэлт хөшөө</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <input type="submit" class="btn btn-danger" name="hushuuhold" value="Архивлах"/>
                            </div>
                            </form>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-sm-3" style="display: flex; justify-content: flex-end;">
                                <input type="text" id="filterName" class="form-control" onkeyup="tablefilter(3, 100)" placeholder="Нэрээр ...">
                            </div>
                            <div class="col-sm-3" style="display: flex; justify-content: flex-end;">
                                <input type="text" id="filterPhone" class="form-control" onkeyup="tablefilter(6, 100)" placeholder="Утасны дугаараар ...">
                            </div>
                            <div class="col-sm-3" style="display: flex; justify-content: flex-end;">
                                    ...
                                    if ($countAz > 0) {
                                        while (_fetch($stmtAz)) {
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>$payidAz</td>
                                                    <td>$tval</td>
                                                    <td><div class='editcell' onblur='updateValue(this, \"$itemidAz\", \"zovog\")' contenteditable>$ovognerAz</div></td>
                                                    <td><div class='editcell' onblur='updateValue(this, \"$itemidAz\", \"zner\")' contenteditable>$hendAz</div></td>
    ...
    <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('АЗ ЖАРГАЛЫН БУРХАН - ' + dateTime + '.' + (type || 'xlsx')));
        }
