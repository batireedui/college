...
_select(
    $stmtHuuhed,
    $countHuuhed,
    "SELECT orders.payid, orders.id, UPPER(tner), UPPER(ehovogner), tognoo, utas, zproducts.price, itemhuuhed.id, itemhuuhed.dtuluv FROM `itemhuuhed` INNER JOIN orders ON itemhuuhed.orderid = orders.id INNER JOIN zproducts ON itemhuuhed.zproductid = zproducts.id WHERE tuluvs=? and tuluv = ? GROUP BY itemhuuhed.id DESC",
    "ii",
    ['0', '1'],
    $payidHuuhed,
    $oidHuuhed,
...
<div class="main-panel">
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Хүүхдийн авралын бунхан</h4>
                    ...
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <div class="col-sm-2">
                                    <input type="submit" class="btn btn-danger" name="huuhedhold" value="Архивлах"/>
                                </div>
                                </form>
                        </div>
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-sm-3" style="display: flex; justify-content: flex-end;">
                                <input type="text" id="filterName" class="form-control" onkeyup="tablefilter(5, 100)" placeholder="Ээжийн нэрээр хайх">
                            </div>
                            <div class="col-sm-3" style="display: flex; justify-content: flex-end;">
                                    ...
                                    if ($countHuuhed > 0) {
                                        while (_fetch($stmtHuuhed)) {
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>$payidHuuhed</td>
                                                    <td>$tval</td>
                                                    <td><div class='editcell' onblur='updateValue(this, \"$itemidHuuhed\", \"tner\")' contenteditable>$tnerHuuhed</div></td>
                                                    <td><div class='editcell' onblur='updateValue(this, \"$itemidHuuhed\", \"tognoo\")' contenteditable>$tognooHuuhed</div></td>
    ...
    <script>
        ...
        function ExportToExcel(type, fn, dl) {
            ...
            return dl ?
                ...
                XLSX.writeFile(wb, fn || ('Хүүхдийн авралын бунхан-' + dateTime + '.' + (type || 'xlsx')));
        }
