...
<div class="row">
    <div class="col-sm-6">
        ...
        _selectNoParam(
            $productsubstmt,
            $productsubcount,
            "SELECT id, name FROM productsub WHERE turul='avral'",
            $productsubid,
            $productsubname
        );
        ?>
    ...
    <div class="col-sm-6">
        ...
        _selectNoParam(
            $sproductsubstmt,
            $sproductsubcount,
            "SELECT productsubid.id, name FROM `productsubid` INNER JOIN productsub ON productsubid.subid = productsub.id WHERE turul='avral' and productsubid.pid='$id'",
            $sproductsubid,
            $sproductsubname
        );
        ?>
